...
export const DISCORD_OAUTH_URL = `https://discord.com/api/oauth2/authorize?client_id=${import.meta.env.DISCORD_CLIENT_ID}&redirect_uri=${encodeURIComponent(
  import.meta.env.WEBSITE_BASE_URL + "/login",
